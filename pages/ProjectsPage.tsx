  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto space-y-16">
        <div>
          <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">{t('exams.reviews.title')}</h3>
          {renderLinks(reviews)}
        </div>
        <div>
          <h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">{t('exams.finals.title')}</h3>
          {renderLinks(finals)}
        </div>
      </div>
    </div>
